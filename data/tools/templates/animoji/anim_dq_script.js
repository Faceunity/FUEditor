(function () {
    ...
    var Animation = function (filename) {
        ...
        this.update_callback = function (target, params) {
            ...
            if (target.use_vtf == 1)
            {
                FaceUnity.LoadAnimationFrame(target.tex_deform, this.animObj.frames, target.tex_deform.h, fid, 1,params);
            }
            else
                FaceUnity.LoadAnimationFrame(target.arrvec4_deform, this.animObj.frames, target.tex_deform.h, fid, 0,params);
        }
