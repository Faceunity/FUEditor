(function(){
	...
	*/
	...
	//自发光强度
	//@mparam Ka_r {"type":"slider","min":0,"max":1,"default_value":0}
	//@mparam Ka_g {"type":"slider","min":0,"max":1,"default_value":0}
	//@mparam Ka_b {"type":"slider","min":0,"max":1,"default_value":0}
	//漫反射强度
	//@mparam Kd_r {"type":"slider","min":0,"max":1,"default_value":0.3}
	//@mparam Kd_g {"type":"slider","min":0,"max":1,"default_value":0.3}
	//@mparam Kd_b {"type":"slider","min":0,"max":1,"default_value":0.3}
	//高光强度，注意高光不受颜色贴图影响
	//@mparam Ks_r {"type":"slider","min":0,"max":1,"default_value":0.2}
	//@mparam Ks_g {"type":"slider","min":0,"max":1,"default_value":0.2}
	//@mparam Ks_b {"type":"slider","min":0,"max":1,"default_value":0.2}
	//环境图反射强度
	...
	*/
	...
	Mesh.prototype.renderEvent = function (blendshape, params, pass, shader, animation, fid) {
		...
		var kd = [V(matex.Kd_r, 0.3),V(matex.Kd_g, 0.3),V(matex.Kd_b, 0.3)];
		var ks = [V(matex.Ks_r, 0.2),V(matex.Ks_g, 0.2),V(matex.Ks_b, 0.2)];
		...
		var shaderParams = {
		    ...
		    mat_proj: mat_proj,
		    tex_albedo: albedo,
			tex_ao: tex_map[V(matex.tex_ao, "white.png")],
		    lbrt: lbrt,
		    ...
		    Ka: ka, Kd: kd, Ks: ks, Kr: V(matex.Kr, 0.0),
