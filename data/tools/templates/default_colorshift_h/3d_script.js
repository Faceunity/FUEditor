	    ...
	    try {
	        ...
	        if (pass == 1) {
				...
				if(need_recompute_facepup){
					...
					FaceUnity.FacePupWithCoef(this.blendshape, undefined,params);
				...
				if(facepup_mode){
					...
					FaceUnity.ComputeBlendshapeGeometry(this.blendshape,params,facepup_expr.length);
					params.expression = expression;
				}else{
					if(computeonce){
						FaceUnity.ComputeBlendshapeGeometryRaw(this.blendshape,params);
					}else{
