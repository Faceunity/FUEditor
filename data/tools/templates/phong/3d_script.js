(function(){
	...
	*/
	...
	//phong高光的余弦幂
	//@mparam cosine_power {"type":"slider","min":2.0,"max":100,"default_value":20.0}
	//高光强度，注意高光不受颜色贴图影响(镜面反射颜色，颜色只为黑色，可调亮度)
	...
	*/
	...
	Mesh.prototype.renderEvent = function (blendshape, params, pass, shader, animation, fid) {
		...
		var shaderParams = {
			...
			specular_color: V(matex.specular_color, 0.2), reflectivity: V(matex.reflectivity, 0.5),
			...
			cosine_power:  V(matex.cosine_power, 20.0)
