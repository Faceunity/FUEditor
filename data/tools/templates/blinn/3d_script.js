(function(){
	...
	*/
	...
	//blinn高光的偏心率
	//@mparam eccentricity {"type":"slider","min":0.0,"max":1.0,"default_value":0.3}
	//blinn高光的镜面衰减系数
	//@mparam specular_roll_off {"type":"slider","min":0.0,"max":1.0,"default_value":0.7}
	//高光强度，注意高光不受颜色贴图影响
	...
	//环境图反射强度
	//@mparam reflectivity {"type":"slider","min":0,"max":1,"default_value":0.5}
	...
	*/
	...
	Mesh.prototype.renderEvent = function (blendshape, params, pass, shader, animation, fid) {
		...
		var shaderParams = {
			...
			specular_color: V(matex.specular_color, 0.5), reflectivity: V(matex.reflectivity, 0.5),
			...
			eccentricity: V(matex.eccentricity, 0.3),
			specular_roll_off: V(matex.specular_roll_off, 0.7)
			//transparent: V(matex.transparent, 0.0)
		};
