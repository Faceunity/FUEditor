...
- 动画参数释意：
 ...
 __注 2__：当出现，全屏元素没有覆盖满全屏时，需要设置,Android/iOS一样  
 ```C
...
- 全局参数  
  ...
  - "is_fixpos": 是否固定位置,不跟随人脸运动，固定位置如下fixed_x/y/z。  
  - "fixed_x":在没有人脸的时候的固定位置 ,x.   
  - "fixed_y":在没有人脸的时候的固定位置 ,y.   
  - "fixed_z":在没有人脸的时候的固定位置 ,z,z 向里，越大越远.  
  - "isnofacerender":在没有人脸的时候是否绘制, 如果绘制，那么已上面的点为固定点。   
